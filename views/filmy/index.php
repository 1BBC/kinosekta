...
\Yii::$app->view->registerMetaTag([
    'name' => 'description',
    'content' => 'Возникают проблемы с поиском фильма? Воспользуйтесь нашей большой и удобной онлайн кинотекой. Смотрите бесллатно кино в хорошем качестве без регистрации',
]);
