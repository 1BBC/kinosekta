...
<div class="container" style="background-color: #FFFFFF; box-shadow: 0 0 1px rgba(0,0,0,0.5);;">
    <div class="row" id="main">
        <div id="content" class="col-lg-9 col-12">
            ...
            <div class="title">
                <h1 class="font-weight-bold"><?= $people['orig_name']?></h1>
            </div>
                ...
                <div class="col-lg-9 col-sm-8">
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <?= count($people['movies']) . '/' . count($people['tvs']) ?><code> (на сайте)</code>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <?php if (!empty($people['biography'])):?>
                        <div class="mt-2">
                            <h2>Биография</h2>
                            <div id="article" itemprop="description"><?= nl2br(($people['biography'] ?? '')) ?></div>
                        </div>
                    <?php endif;?>
                </div>
            </div>
