...
/**
 * BlockedController implements the CRUD actions for Blocked model.
 */
class BlockedController extends Controller
{
    ...
    /**
     * Deletes an existing Blocked model.
     ...
     * @param integer $id
     * @return Blocked the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
